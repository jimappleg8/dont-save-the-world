...
# 5 Reasons to Buy *Don't Save The World*

## {% spanClass "text-accent-warm text-normal" %}Reason 1: Help Build a Better World{% endspanClass %}
...
## {% spanClass "text-accent-warm" %}Reason 2: A New, Old Kind of Activism{% endspanClass %}
...
## {% spanClass "text-accent-warm" %}Reason 3: Hope for the Future, Now{% endspanClass %}
...
One of the guiding principles in *Don't Save The World* is that individuals drive real change. There isn't anything more powerful than a person with a good idea, except perhaps millions of people with good ideas supporting each other to realize them. The ability to take meaningful action brings with it hope for the future, and this book is all about taking meaningful action.

It doesn't matter if you are feeling a little low on ideas at the moment; other creators are looking for people with your skills to help them develop their ideas. It doesn't matter if you have only a tiny amount of time to contribute; you get to decide what you work on, when you do it, and for how long. And it doesn't matter if you don't think you have any usable skills; part of the goal is for you to grow, so you can learn on the job.

If you've been looking for a way to stop worrying about the future and start making a difference using the best of your experience, knowledge, skills, and time, {% externalLink "get your copy of <i>Don't Save the World</i> today!", "https://a.co/d/0j7BB2zj" %}.

## {% spanClass "text-accent-warm" %}Reason 4: A Practical Guide{% endspanClass %}
...
## {% spanClass "text-accent-warm" %}Reason 5: Available Now{% endspanClass %}
...
{% button "Order now on Amazon.com", "https://a.co/d/0j7BB2zj" %}
